...
public class SplashProgress {
  ...
  public static void drawSplash(TextureManager tm) {
		  ...
		  int scaleFactor = scaledResolution.getScaleFactor();
		   ...
		   if(splash==null) {
			   splash = new ResourceLocation("lupical/lupus.png");
		   }
		   ...
		   framebuffer.framebufferRender(scaledResolution.getScaledHeight()*scaleFactor,scaledResolution.getScaledHeight()* scaleFactor);
		   GlStateManager.enableAlpha();
		   GlStateManager.alphaFunc(516,0.1f);
		   Minecraft.getMinecraft().updateDisplay();
  }
	  private static  void drawProgres() {
		  ...
		  GlStateManager.resetColor();
		  resetTexturesState();
		  ufr.drawString(CURRENT,20,sr.getScaledHeight()-25,0xFFFFFFF);
		  ...
		  Gui.drawRect(0, sr.getScaledHeight()-2, sr.getScaledWidth(), sr.getScaledHeight(), new Color(10,10,10).getRGB());
	  }
